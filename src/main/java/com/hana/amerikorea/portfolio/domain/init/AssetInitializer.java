...
public class AssetInitializer implements CommandLineRunner {
    ...
    @Autowired
    public AssetInitializer(StockRepository stockRepository) {
    ...
    public void run(String... args) throws Exception {
        // 더미 데이터 삽입
        Asset stock1 = new Asset("AAPL", "Apple Inc.", Sector.IT, "Consumer Electronics", "NASDAQ", "USA", 50, 500000, 10000, 5000, 150, "March", 1.5, 0.82, DividendFrequency.QUARTERLY);
        Asset stock2 = new Asset("GOOGL", "Alphabet Inc.", Sector.COMMUNICATION, "Internet Services", "NASDAQ", "USA", 30, 450000, 12000, 7000, 160, "June", 1.2, 0.00, DividendFrequency.ANNUALLY);
        Asset stock3 = new Asset("AMZN", "Amazon.com Inc.", Sector.CD, "E-Commerce", "NASDAQ", "USA", 20, 300000, 15000, 8000, 170, "September", 1.0, 0.00, DividendFrequency.ANNUALLY);
        Asset stock4 = new Asset("TSLA", "Tesla Inc.", Sector.CD, "Automobiles", "NASDAQ", "USA", 10, 200000, 20000, 10000, 180, "December", 0.8, 0.00, DividendFrequency.ANNUALLY);
        Asset stock5 = new Asset("MSFT", "Microsoft Corporation", Sector.IT, "Software", "NASDAQ", "USA", 40, 400000, 9000, 6000, 155, "March", 1.3, 0.56, DividendFrequency.QUARTERLY);
